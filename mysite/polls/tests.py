...
class QuestionDetailViewTests(test.TestCase):
    def test_future_question(self):
        ...
        url = urls.reverse("polls:detail", args=(future_question.id,))
    ...
    def test_past_question(self):
        ...
        url = urls.reverse("polls:detail", args=(past_question.id,))
        response = self.client.get(url)
        self.assertContains(response, past_question.question_text)


class QuestionIndexViewTests(test.TestCase):
